package com.example.ex11_1_movieview2
    ...
    inner class MyGridAdapter(var context: Context) : BaseAdapter() {
        ...
        override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
            ...
            imageView.setOnClickListener{
                ...
                var tvPoster = dialogView.findViewById<TextView>(R.id.tvPoster)
//                tvPoster.setText(posterTitle[p0])
        ...
        var posterTitle = arrayOf(
            "써니","완득이","괴물","라디오스타","비열한거리","왕의남자","아일랜드","웰컴투동막골","헬보이","빽투더퓨처"
        )
